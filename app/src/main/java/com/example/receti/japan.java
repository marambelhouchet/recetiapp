...
public class japan extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addbtn.setOnClickListener(v -> startActivity(new Intent(japan.this, add.class)));
    ...
    private void downloadAndParseJsonFile() {
        ...
        StorageReference jsonFileRef = storageRef.child("japan.json");
        ...
        jsonFileRef.getBytes(ONE_MEGABYTE)
                .addOnSuccessListener(new OnSuccessListener<byte[]>() {
                    ...
                    public void onSuccess(byte[] bytes) {
                        new japan.ParseJsonTask().execute(bytes);
                    }
                })
