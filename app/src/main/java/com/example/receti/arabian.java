...
public class arabian extends AppCompatActivity {
    private static final String TAG = "arabianActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.arabian);
        ...
        addbtn.setOnClickListener(v -> startActivity(new Intent(arabian.this, add.class)));
    ...
    private void downloadAndParseJsonFile() {
        ...
        StorageReference jsonFileRef = storageRef.child("arabian.json");
