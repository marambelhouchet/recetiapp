...
public class korean extends AppCompatActivity {
    ...
    private static final String TAG = "KoreanActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addbtn.setOnClickListener(v -> startActivity(new Intent(korean.this, add.class)));
        downloadAndParseJsonFile();
    }

    public void downloadAndParseJsonFile() {
        FirebaseStorage storage = FirebaseStorage.getInstance();
        StorageReference storageRef = storage.getReferenceFromUrl("gs://receti-9e4a9.appspot.com");
        StorageReference jsonFileRef = storageRef.child("run_resultss.json");
    ...
    public  class ParseJsonTask extends AsyncTask<byte[], Void, String> {
        @Override
    ...
    public void parseJsonData(String jsonContent) {
        try {
