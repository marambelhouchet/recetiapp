...
public class ind extends AppCompatActivity  {
    private static final String TAG = "indActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addbtn.setOnClickListener(v -> startActivity(new Intent(ind.this, add.class)));
    ...
    private void downloadAndParseJsonFile() {
        ...
        StorageReference jsonFileRef = storageRef.child("ind.json");
        ...
        jsonFileRef.getBytes(ONE_MEGABYTE)
                .addOnSuccessListener(new OnSuccessListener<byte[]>() {
                    ...
                    public void onSuccess(byte[] bytes) {
                        new ind.ParseJsonTask().execute(bytes);
                    }
                })
