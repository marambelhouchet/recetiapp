...
public class span extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addbtn.setOnClickListener(v -> startActivity(new Intent(span.this, add.class)));
    ...
    private void downloadAndParseJsonFile() {
        ...
        StorageReference jsonFileRef = storageRef.child("span.json");
        ...
        jsonFileRef.getBytes(ONE_MEGABYTE)
                .addOnSuccessListener(new OnSuccessListener<byte[]>() {
                    ...
                    public void onSuccess(byte[] bytes) {
                        new span.ParseJsonTask().execute(bytes);
                    }
                })
