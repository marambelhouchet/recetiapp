...
public class italien extends AppCompatActivity {
    private static final String TAG = "italianActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addbtn.setOnClickListener(v -> startActivity(new Intent(italien.this, add.class)));
    ...
    private void downloadAndParseJsonFile() {
        ...
        StorageReference jsonFileRef = storageRef.child("italian.json");
