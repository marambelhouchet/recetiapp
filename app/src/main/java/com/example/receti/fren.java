...
public class fren extends AppCompatActivity  {
    private static final String TAG = "frenActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fren);
        recyclerView = findViewById(R.id.r);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        recipeList = new ArrayList<>();
        adapter = new RecipeAdapter(recipeList, this);
        recyclerView.setAdapter(adapter);addbtn = findViewById(R.id.add);
        addbtn.setOnClickListener(v -> startActivity(new Intent(fren.this, add.class)));
    ...
    private void downloadAndParseJsonFile() {
        ...
        StorageReference jsonFileRef = storageRef.child("fren.json");
        ...
        jsonFileRef.getBytes(ONE_MEGABYTE)
                .addOnSuccessListener(new OnSuccessListener<byte[]>() {
                    ...
                    public void onSuccess(byte[] bytes) {
                        new fren.ParseJsonTask().execute(bytes);
                    }
                })
